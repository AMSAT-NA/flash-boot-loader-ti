...
void setupPLL(void) {
	...
	systemREG1->PLLCTL1 = 0x00000000U | 0x20000000U | ((0x1F) << 24U) /* R-divider, will be programmed later in mapClock() */
	| 0x00000000U | ((6U - 1U) << 16U) /*reference clock divider:6 */
	 ...
	 */
	systemREG1->PLLCTL2 = 0x00000000U | (255U << 22U) | (7U << 12U)
	 ...
	 *     - Setup Pll multiplier          
	 */
	systemREG2->PLLCTL3 = ((2U - 1U) << 29U) | ((0x1F) << 24U)
			| ((5U - 1U) << 16U) | ((30U - 1U) << 8U);
...
void trimLPO(void) {
	...
	if (LPO_TRIM_VALUE != 0xFFFF) {
		...
		systemREG1->LPOMONCTL = (1U << 24U) | LPO_TRIM_VALUE;
	} else {

		systemREG1->LPOMONCTL = (1U << 24U) | (16U << 8U) | 8U;
	}
...
void setupFlash(void) {
	...
	flashWREG->FBFALLBACK = 0x00000000 | (SYS_ACTIVE << 14U)
			| (SYS_SLEEP << 12U) | (SYS_SLEEP << 10U) | (SYS_SLEEP << 8U)
			| (SYS_SLEEP << 6U) | (SYS_SLEEP << 4U)
#if defined(TMS570LS04) || defined(RM42)
                          | (SYS_SLEEP << 2U)
#else
			| (SYS_ACTIVE << 2U)
...
void mapClocks(void) {
	...
	while ((systemREG1->CSVSTAT & ((systemREG1->CSDIS ^ 0xFF) & 0xFF))
			!= ((systemREG1->CSDIS ^ 0xFF) & 0xFF)) {
	}
//    while (!(systemREG1->CSVSTAT & 0x040));
...
#else
	systemREG1->PLLCTL1 = (systemREG1->PLLCTL1 & 0xE0FFFFFF)
			| ((1U - 1U) << 24U);
#endif
	systemREG2->PLLCTL3 = (systemREG2->PLLCTL3 & 0xE0FFFFFF)
			| ((1U - 1U) << 24U);
	...
	systemREG1->GHVSRC = (SYS_PLL1 << 24U) | (SYS_PLL1 << 16U) | SYS_PLL1;
	...
	systemREG1->RCLKSRC = (1U << 24U) | (SYS_VCLK << 16U) | (1U << 8U)
			| SYS_VCLK;

	/** - Setup asynchronous peripheral clock sources for AVCLK1 and AVCLK2 */
	systemREG1->VCLKASRC = (SYS_VCLK << 8U) | SYS_VCLK;

	systemREG2->VCLKACON1 = (1U << 24) | 1 << 20U | (SYS_VCLK << 16) | (1U << 8)
			| 1 << 4U
#if defined(TMS570LS04) || defined(RM42)
                           | SYS_VCLK;
#else
...
void systemInit(void) {
	...
	/** - Setup ECLK */
	systemREG1->ECPCNTL = (0U << 24U) | (0U << 23U) | ((8U - 1U) & 0xFFFFU);
