...
static const t_isrFuncPTR s_vim_init[] = { &phantomInterrupt, &esmHighInterrupt,
		&phantomInterrupt, &phantomInterrupt, &phantomInterrupt,
		&phantomInterrupt, &phantomInterrupt, &phantomInterrupt,
		&phantomInterrupt, &phantomInterrupt, &phantomInterrupt,
		&phantomInterrupt, &phantomInterrupt, &phantomInterrupt,
		&phantomInterrupt, &phantomInterrupt, &phantomInterrupt,
	...
	if (&__TI_Handler_Table_Base < &__TI_Handler_Table_Limit) {
		...
		while (tablePtr < tableLimit) {
			...
			handler_fptr handler =
					(handler_fptr) (&__TI_Handler_Table_Base)[idx];
